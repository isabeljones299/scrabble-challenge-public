...
This coding challenge was completed as part of my application to Digital Futures training academy. To view the comfirmation of functionality use `npm test`. 
